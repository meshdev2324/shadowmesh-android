...
dependencies {
    ...
    // Horizon 4: Glimmer UI for Display Glasses
    implementation("androidx.xr.glimmer:glimmer:0.1.0-alpha01")
    implementation("androidx.xr.glimmer:glimmer-google-fonts:0.1.0-alpha01")
